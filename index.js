...
// ANSWER:Because the for loop limits the amount of time
...
function getNumbersSquared(numbers) {
  ...
  let answers = []
    ...
    let squaredValue = Math.pow(...numbers, 2)
    answers.push(squaredValue)
  return answers
}
...
// ANSWER: Because the function is taking any string so it could be different.